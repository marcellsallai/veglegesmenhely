    ...
    render() {
        const onSuccess = (payment) => {
            // Congratulation, it came here means everything's fine!
            		console.log("Sikeres fizetés!", payment);
        ...
        const onCancel = (data) => {
            ...
            console.log('A fizetés megszakítva!', data);
        ...
        const client = {
            sandbox:    'ASTtSqrYxhU5hK-7_8EEuyMOfDAz4OvT8FZX9gpLXcMZZ7aOEfzT_8tkalHIYNhWmPCvrHWJPk-PyuGA',
